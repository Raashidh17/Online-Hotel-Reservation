...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9344769025</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Amenities – Highlight the kind of amenities the hotel offers. If there is a pool, spa, gym, restaurant, or bar you are going to want to mention that. As well as free breakfast. Rooms – Inform consumers of the types of rooms you have and point out if they are accessible, spacious, modern, or well-appointed.</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Lucas Jimenez</h4>
							<span>Manager</span>
							<p> I am the manager of this hotel good to stay in our hotel.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Hi,welcome you all to this luxurious hotel we provide all the faclities you want </p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p> Good facilities, i am enjoyed this stay 
								<p>Italy</p>
							</div>
							<div class="clearfix"> </div>
						</li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9344769025</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New street, Chennai, Tamilnadu, India</p>
